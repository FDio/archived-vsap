...
.PHONY: build-vcl
build-vcl: $(BR)/.deps.ok openssl-dl nginx-dl openssl-build vcl_vpp-build vcl_nginx-build

.PHONY: build-ldp
build-ldp: $(BR)/.deps.ok openssl-dl nginx-dl openssl-build ldp_vpp-build ldp_nginx-build


.PHONY: deb-vcl
deb-vcl: build-vcl openssl-deb vcl_vpp-deb vcl_nginx-deb

.PHONY: deb-ldp
deb-ldp: build-ldp openssl-deb ldp_vpp-deb ldp_nginx-deb
